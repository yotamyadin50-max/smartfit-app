...
const EXERCISE_DEFS: Record<string, ExerciseDef> = {
  ...
  'hollow hold':             { muscles: ['core', 'upper-abs', 'lower-abs', 'hip-flexors'], anim: 'plank' },
  'bulgarian split squat':   { muscles: ['quads', 'glutes', 'hamstrings'], anim: 'lunge' },
  'hip thrust':              { muscles: ['glutes', 'hamstrings', 'core'], anim: 'glute-bridge' },
  'wall sit':                { muscles: ['quads', 'glutes', 'hamstrings'], anim: 'squat' },
  'step-up':                 { muscles: ['quads', 'glutes'], anim: 'lunge' },
  'jump squat':              { muscles: ['quads', 'glutes', 'calves'], anim: 'squat' },
  'pike push-up':            { muscles: ['front-delts', 'triceps', 'chest'], anim: 'push-up' },
  'hammer curl':             { muscles: ['biceps', 'forearms'], anim: 'curl' },
  'overhead triceps extension': { muscles: ['triceps'], anim: 'triceps-push' },
  'lateral raise':           { muscles: ['side-delts'], anim: 'lateral-raise' },
  'concentration curl':      { muscles: ['biceps'], anim: 'curl' },
  'wide push-up':            { muscles: ['chest', 'front-delts', 'core'], anim: 'push-up' },
  'diamond push-up':         { muscles: ['triceps', 'chest', 'front-delts'], anim: 'push-up' },
  'decline push-up':         { muscles: ['chest', 'front-delts', 'triceps'], anim: 'push-up' },
  'archer push-up':          { muscles: ['chest', 'triceps', 'front-delts'], anim: 'push-up' },
  'superman':                { muscles: ['lower-back', 'glutes', 'hamstrings', 'traps'], anim: 'back-extension' },
  'good morning':            { muscles: ['lower-back', 'hamstrings', 'glutes'], anim: 'back-extension' },
  'bent-over row':           { muscles: ['lats', 'biceps', 'upper-back', 'rear-delts'], anim: 'row' },
  'single leg deadlift':     { muscles: ['hamstrings', 'glutes', 'lower-back'], anim: 'back-extension' },
  'renegade row':            { muscles: ['lats', 'biceps', 'core', 'upper-back'], anim: 'row' },
  'back extension hold':     { muscles: ['lower-back', 'glutes', 'traps'], anim: 'back-extension' },
  'inchworm':                { muscles: ['core', 'lower-back', 'front-delts'], anim: 'back-extension' },
  'dumbbell chest fly':      { muscles: ['chest', 'front-delts'], anim: 'cable-fly' },

  // Gym machine extras
  'romanian deadlift':       { muscles: ['hamstrings', 'glutes', 'lower-back'], anim: 'back-extension' },
  'pull-up':                 { muscles: ['lats', 'biceps', 'upper-back'], anim: 'pulldown' },
  'chin-up':                 { muscles: ['lats', 'biceps', 'rear-delts'], anim: 'pulldown' },
  't-bar row':               { muscles: ['lats', 'upper-back', 'biceps', 'rear-delts'], anim: 'row' },
  'lat pullover machine':    { muscles: ['lats', 'triceps', 'chest'], anim: 'pulldown' },
  'hack squat':              { muscles: ['quads', 'glutes', 'hamstrings'], anim: 'squat' },
  'hip abduction machine':   { muscles: ['glutes', 'hip-flexors'], anim: 'lateral-raise' },
  'hip adduction machine':   { muscles: ['quads', 'glutes'], anim: 'lateral-raise' },
  'seated calf raise machine': { muscles: ['calves'], anim: 'calf-raise' },
  'arnold press':            { muscles: ['front-delts', 'side-delts', 'triceps'], anim: 'overhead-press' },
  'dumbbell lateral raise':  { muscles: ['side-delts'], anim: 'lateral-raise' },
  'front raise':             { muscles: ['front-delts', 'side-delts'], anim: 'lateral-raise' },
  'cable curl':              { muscles: ['biceps', 'forearms'], anim: 'curl' },
  'ez-bar curl':             { muscles: ['biceps', 'forearms'], anim: 'curl' },
  'close-grip bench press':  { muscles: ['triceps', 'chest', 'front-delts'], anim: 'chest-press' },
